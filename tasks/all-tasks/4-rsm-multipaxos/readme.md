...
Узел-прокси эти ситуации не различает, он просто отправляет команду другой реплике.
...
- Каждая отправленная в RSM команда применится к автомату каждой из реплик только один раз.
