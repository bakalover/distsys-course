...
```shell
clippy attach https://gitlab.com/distsys-course-2021/test-roman-lipovsky-u-lipovsky
```
...
```shell
clippy attach git@gitlab.com:distsys-course-2021/test-roman-lipovsky-u-lipovsky
```
